        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    senderBankAccNo = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    transferAmt = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    ReceiverBankName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ReceiverBankAccNo = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ExchangeRate = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    PayoutAmt = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TransactionDetails_Users_Id",
                        column: x => x.Id,
                        principalSchema: "UserManagement",
                        principalTable: "Users",
                        principalColumn: "Id",
